export const en = {
  ...
  hero: {
    subtitle: "PREMIUM REAL ESTATE & SEASIDE STAYS",
    title: "Own, Invest, or Stay — All in One Place",
    description: "Explore a curated marketplace of premium properties for sale and elegant apartments for rent. Discover verified listings, secure payments, and seamless ownership transfer — built for a modern real estate experience.",
  ...
  home: {
    welcome: {
      ...
      title: "Premium Properties & Luxury Stays",
      description1: "MareSereno is your trusted destination for buying premium real estate and renting high-end apartments. We combine elegant design with modern technology to make discovery, purchasing, and stay management effortless.",
      description2: "From beachfront villas to city apartments, our listings are curated and verified. Enjoy transparent pricing, secure checkout, and digital contract signing — all in one place.",
